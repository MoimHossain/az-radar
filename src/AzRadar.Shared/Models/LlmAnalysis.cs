...
{
    /// <summary>
    /// A concise, accurate, human-readable title generated by the LLM that reflects the actual
    /// substance of the change (e.g. the specific retirement/deprecation/feature), rather than
    /// the often generic or misleading title of the source document/feed entry.
    /// </summary>
